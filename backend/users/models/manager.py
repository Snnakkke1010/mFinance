...
class CustomUserManager(BaseUserManager):
    ...
    def email_validator(self, email):
        try:
            ...
            ValueError(_("Please enter a value email address"))
        
    def create_user(self, email, first_name, second_name, password, **extra_fields):
        if email:
        ...
        if not second_name:
            raise ValueError(_("second name is required"))
